...
```{r, include=T}
p1.expr.genes = select_expressed_genes(p1.norm.gene.counts.deseq2)

p2.expr.genes = select_expressed_genes(p2.norm.gene.counts.deseq2)

pM.expr.genes = select_expressed_genes(pM.norm.gene.counts.deseq2)
