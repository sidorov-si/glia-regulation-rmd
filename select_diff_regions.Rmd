...
saveRDS(p1.dep.nfia.ranges, file = "../r_results/select_diff_regions/p1_dep_nfia_ranges.rds")

p2.dep.nfia.ranges = p2.dep.ranges[p2.dep.ranges@ranges@NAMES %in% p2.matched.regions]

saveRDS(p2.dep.nfia.ranges, file = "../r_results/select_diff_regions/p2_dep_nfia_ranges.rds")

pM.dep.nfia.ranges = pM.dep.ranges[pM.dep.ranges@ranges@NAMES %in% pM.matched.regions]

saveRDS(pM.dep.nfia.ranges, file = "../r_results/select_diff_regions/pM_dep_nfia_ranges.rds")
```
