...
```{r, include=T}
p1.11.7.dep = readRDS("../r_results/diff_accessibility/tables/p1_D11_vs_D7_dep.rds")

p2.11.7.dep = readRDS("../r_results/diff_accessibility/tables/p2_D11_vs_D7_dep.rds")

pM.11.7.dep = readRDS("../r_results/diff_accessibility/tables/pM_D11_vs_D7_dep.rds")
...
p1.dep.ranges = select.dep.regions(p1.11.7.dep, p1, "../r_results/select_diff_regions/p1_D11_vs_D7_dep.bed")

p2.dep.ranges = select.dep.regions(p2.11.7.dep, p2, "../r_results/select_diff_regions/p2_D11_vs_D7_dep.bed")

pM.dep.ranges = select.dep.regions(pM.11.7.dep, pM, "../r_results/select_diff_regions/pM_D11_vs_D7_dep.bed")
```
...
p1.matched.regions = scan.tf.motif(domain.name = "p1", 
                                   ...
                                   strand = "+", 
                                   min.score = "80%", 
                                   sites.filename = "../r_results/select_diff_regions/p1_nfia_hm_sites_df.rds")
...
p2.matched.regions = scan.tf.motif(domain.name = "p2", 
                                   ...
                                   strand = "+", 
                                   min.score = "80%", 
                                   sites.filename = "../r_results/select_diff_regions/p2_nfia_hm_sites_df.rds")
...
pM.matched.regions = scan.tf.motif(domain.name = "pM", 
                                   ...
                                   strand = "+", 
                                   min.score = "80%", 
                                   sites.filename = "../r_results/select_diff_regions/pM_nfia_hm_sites_df.rds")
```

Select NFIA-dependent regions with NFIA matches:

```{r, include=T}
p1.up.nfia.names = p1.matched.regions[p1.matched.regions %in% p1.up.ranges@ranges@NAMES]

p1.up.nfia.ranges = p1.up.ranges[p1.up.ranges@ranges@NAMES %in% p1.up.nfia.names]

saveRDS(p1.up.nfia.ranges, file = "../r_results/select_diff_regions/p1_up_nfia_ranges.rds")

p2.up.nfia.names = p2.matched.regions[p2.matched.regions %in% p2.up.ranges@ranges@NAMES]

p2.up.nfia.ranges = p2.up.ranges[p2.up.ranges@ranges@NAMES %in% p2.up.nfia.names]

saveRDS(p2.up.nfia.ranges, file = "../r_results/select_diff_regions/p2_up_nfia_ranges.rds")

pM.up.nfia.names = pM.matched.regions[pM.matched.regions %in% pM.up.ranges@ranges@NAMES]

pM.up.nfia.ranges = pM.up.ranges[pM.up.ranges@ranges@NAMES %in% pM.up.nfia.names]

saveRDS(pM.up.nfia.ranges, file = "../r_results/select_diff_regions/pM_up_nfia_ranges.rds")
```
