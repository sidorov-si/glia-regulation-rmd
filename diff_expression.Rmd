...
Plot proportions of differentially expressed genes, for the sake of completeness:

```{r, include=T}
p1.deg.proportions.plot = plot_deg_proportions(p1.deg_proportions, 
                                               "deg-proportions_diff-expression_p1-MUT-D11-NFIAn_vs_p1-WT-D11-NFIAp.pdf")

# p1.deg.proportions.plot
```
...
Plot the proportions of differentially expressed genes, for the sake of completeness:

```{r, include=T}
p2.deg.proportions.plot = plot_deg_proportions(p2.deg_proportions, 
                                               "deg-proportions_diff-expression_p2-MUT-D11-NFIAn_vs_p2-WT-D11-NFIAp.pdf")

# p2.deg.proportions.plot
```
...
```{r, include=T}
pM.deg.proportions.plot = plot_deg_proportions(pM.deg_proportions, 
                                               "deg-proportions_diff-expression_pM-MUT-D11-NFIAn_vs_pM-WT-D11-NFIAp.pdf")

# pM.deg.proportions.plot
```
...
All of the following genes should be downregulated in MUT-D11:
...
Same here! Seems to be a problem with the KO. And hence, the even greater number of differentially expressed genes in MUT-D11 vs WT-D11 could be produced not by the changes in the Nfia expression.
