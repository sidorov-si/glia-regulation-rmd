...
# Save these sets of genes
saveRDS(p1.11.7.dep, file = "../r_results/diff_accessibility/tables/p1_D11_vs_D7_dep.rds")

saveRDS(p2.11.7.dep, file = "../r_results/diff_accessibility/tables/p2_D11_vs_D7_dep.rds")

saveRDS(pM.11.7.dep, file = "../r_results/diff_accessibility/tables/pM_D11_vs_D7_dep.rds")
```

Print out the numbers of NFIA-dependet regions per domain:
