...
p1.bkgd.tad = calc_correlations(p1.vicinity.tad, p1.dep.tss.ranges,
                                ...
                                "p1",
                                "background",
                                paste0("../r_results/predict_correlated_deg/p1_bkgd_in_tad_",
                                       vicinity.radius, "kbp_dep_regions_fdr", fdr, "_min-l2fc", min.l2fc,
                                       "_min-baseMean", min.baseMean, ".rds"))
...
p2.bkgd.tad = calc_correlations(p2.vicinity.tad, p2.dep.tss.ranges,
                                ...
                                "p2",
                                "background",
                                paste0("../r_results/predict_correlated_deg/p2_bkgd_in_tad_",
                                       vicinity.radius, "kbp_dep_regions_fdr", fdr, "_min-l2fc", min.l2fc,
                                       "_min-baseMean", min.baseMean, ".rds"))
...
pM.bkgd.tad = calc_correlations(pM.vicinity.tad, pM.dep.tss.ranges,
                                ...
                                "pM",
                                "background",
                                paste0("../r_results/predict_correlated_deg/pM_bkgd_in_tad_",
                                       vicinity.radius, "kbp_dep_regions_fdr", fdr, "_min-l2fc", min.l2fc,
                                       "_min-baseMean", min.baseMean, ".rds"))
...
ggsave(filename = paste0("../r_results/predict_correlated_deg/plots/p1_bkgd_in_tad_",
                         vicinity.radius, "kbp_dep_regions_fdr", fdr, "_min-l2fc", min.l2fc,
                         "_min-baseMean", min.baseMean, "_hist.pdf"),
       plot = p)
...
ggsave(filename = paste0("../r_results/predict_correlated_deg/plots/p2_bkgd_in_tad_",
                         vicinity.radius, "kbp_dep_regions_fdr", fdr, "_min-l2fc", min.l2fc,
                         "_min-baseMean", min.baseMean, "_hist.pdf"),
       plot = p)
...
ggsave(filename = paste0("../r_results/predict_correlated_deg/plots/pM_bkgd_in_tad_",
                         vicinity.radius, "kbp_dep_regions_fdr", fdr, "_min-l2fc", min.l2fc,
                         "_min-baseMean", min.baseMean, "_hist.pdf"),
       plot = p)
