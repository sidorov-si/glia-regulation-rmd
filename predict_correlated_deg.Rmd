...
saveRDS(p1.norm.counts,
        file = "../r_results/p1_norm_counts_expression.rds")
...
saveRDS(p2.norm.counts,
        file = "../r_results/p2_norm_counts_expression.rds")
...
saveRDS(pM.norm.counts,
        file = "../r_results/pM_norm_counts_expression.rds")
```
...
saveRDS(p1.norm.counts,
        file = "../r_results/p1_norm_counts_accessibility.rds")
...
saveRDS(p2.norm.counts,
        file = "../r_results/p2_norm_counts_accessibility.rds")
...
saveRDS(pM.norm.counts,
        file = "../r_results/pM_norm_counts_accessibility.rds")
```
